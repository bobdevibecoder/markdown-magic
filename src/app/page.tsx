      ...
      <section className="relative overflow-hidden pt-20 pb-16 px-4">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4">
            Convert <span className="text-primary">Markdown</span> to <span className="text-primary">HTML</span> Instantly
          </h1>
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground mb-12">
            Transform Markdown to clean, semantic HTML and vice versa. Perfect for bloggers, developers, and content creators. Free for 10 conversions/day.
          </p>
            ...
            {[
              {
                ...
                desc: "Convert Markdown to HTML and HTML back to Markdown. Handles all standard syntax including tables, code blocks, and footnotes.",
              },
              {
                icon: Shield,
                title: "Privacy First",
                desc: "Your content never leaves your browser for free-tier conversions. Zero tracking, zero storage, complete privacy.",
              },
              {
                icon: Code,
                title: "Developer Friendly",
                desc: "Clean, semantic HTML output. Preserves code block language tags. Perfect for static site generators and CMS imports.",
              },
              {
                icon: Globe,
                title: "REST API",
                desc: "Pro users get full API access with key-based authentication. Integrate conversions into your CI/CD pipelines and workflows.",
              },
            ].map((feature) => (
